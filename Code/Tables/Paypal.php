...
namespace Paypal\Payments\Paypal\Code\Tables;
 ...
 * Paypal
 *
 * @ORM\Table(name="paypal_payments_paypal", indexes={@ORM\Index(name="payment_id_index", columns={"payment_id"}), @ORM\Index(name="created_by_index", columns={"created_by"}), @ORM\Index(name="modified_by_index", columns={"modified_by"})})
 * @ORM\Entity
 * @ORM\HasLifecycleCallbacks
 */
class Paypal extends \Kazist\Table\BaseTable {
